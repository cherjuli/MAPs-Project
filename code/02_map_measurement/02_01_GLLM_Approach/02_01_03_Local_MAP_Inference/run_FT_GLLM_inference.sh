...
# Define parameters 
jobscript=~/FT_GLLM_interference.slurm
...
if [[ $url =~ $url_pattern ]]; then 
    ...
    echo ""
    echo "to:"
    echo "- use the kernel in VSCode ('Existing Jupyter Server...', enter URL (http://$hostID:${port}/lab), enter password, confirm '127.0.0.1', choose kernel) or "
