...
def initialize_GLLM_pipeline(model_id, transformers_cache_dir, device_map, torch_dtype=torch.float16, max_new_tokens=100, temperature=0.001):
    """
...
def run_batched_pipeline_interference(sentences, batch_size, generate_text_pipeline, system_message, user_message, output_column):
